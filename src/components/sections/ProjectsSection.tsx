...
// Categorías enfocadas en valor para el cliente
const CATEGORIES = [
  {
    id: "all",
...
export const ProjectsSection: React.FC = () => {
  ...
  return (
    <Section id="projects" bgColor="darker">
      ...
      {/* Categorías - Diseño minimalista y elegante */}
      <div className="flex flex-wrap justify-center gap-3 mb-16">
        {CATEGORIES.map((cat) => (
          ...
          >
            ...
            {/* Tooltip flotante con descripción */}
            <div
              className="
              absolute -top-10 left-1/2 -translate-x-1/2 
              px-3 py-1.5 rounded-lg bg-indigo-900/90 backdrop-blur-sm 
              text-indigo-200 text-xs whitespace-nowrap
    ...
    >
      <Card className="group h-full overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-950/40 to-purple-950/40 border border-indigo-500/20 hover:border-indigo-500/40 transition-all duration-300 hover:shadow-2xl hover:shadow-indigo-500/10 flex flex-col">
        ...
        <div className="relative h-52 overflow-hidden flex-shrink-0">
          ...
          {/* Overlay con beneficio al hacer hover */}
          <div className="absolute inset-0 bg-gradient-to-t from-indigo-950 via-indigo-950/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-5">
            <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
              ...
              <p className="text-indigo-300 text-xs mt-2">✨ {config.result}</p>
            </div>
          </div>
        ...
        <div className="p-5 flex flex-col flex-grow">
          {/* Título y tecnologías principales */}
          <div className="mb-3">
          ...
          <div className="mt-auto pt-4">
            <button
              onClick={() => {
                // Temporalmente sin acción
                console.log("Ver más:", project.title);
              }}
              className="
                w-full py-2.5 px-4 rounded-xl
                bg-gradient-to-r from-indigo-600/20 to-pink-600/20
                border border-indigo-500/30
                text-indigo-300 text-sm font-medium
                transition-all duration-300
                hover:from-indigo-600/40 hover:to-pink-600/40
            ...
            >
              ...
              <i className="fas fa-arrow-right text-xs transition-transform duration-300 group-hover/btn:translate-x-1" />
            </button>
          </div>
        </div>
      </Card>
